class Item < ApplicationRecord
  ...
  validates :condition_id, numericality: { other_than: 0,message:'は---以外を選択してください' }
  validates :postage_id, numericality: { other_than: 0,message:'は---以外を選択してください' }
  validates :prefecture_id, numericality: { other_than: 0, message:'は---以外を選択してください'}
  validates :day_ship_id, numericality: { other_than: 0, message:'は---以外を選択してください' }
